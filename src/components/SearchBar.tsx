    ...
    <div className="form-control w-full">
      <div className="relative">
        <input
          ...
          className="input input-bordered w-full pr-10 text-base rounded-full
        ...
        {shouldShowDropdown && (
          <div
            ref={dropdownRef}
            className="absolute top-full left-0 right-0 mt-1 bg-base-100 border border-base-300 rounded-lg z-50 max-h-70 overflow-y-auto"
          >
            {isLoading ? (
                ...
                {results.map((token) => (
                  ...
                  >
                    <div
                      ...
                      className="p-3 hover:bg-base-150 cursor-pointer transition-colors flex items-center gap-3"
                    >
