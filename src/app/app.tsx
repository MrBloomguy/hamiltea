...
function App() {
  ...
  const trendingCarouselTokens: Token[] = [];
  const showTrendingCarousel = false && trendingCarouselTokens.length > 0;
  ...
  return (
    <>
      ...
      <div className="flex flex-col row-start-2 w-full items-center">
        <div className="w-full max-w-[1200px] px-4 mx-auto mt-14 sm:mt-16">
          <div className="p-4">
